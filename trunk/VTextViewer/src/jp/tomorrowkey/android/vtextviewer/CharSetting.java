...
public class CharSetting {
    ...
    public static final CharSetting[] settings = {
            ...
            new CharSetting("「", 90.0f, -1.0f, -0.3f), new CharSetting("」", 90.0f, -1.0f, 0.0f),
            ...
            new CharSetting("ー", -90.0f, 0.0f, 0.9f), new CharSetting("a", 90.0f, 0.0f, -0.1f),
            ...
            new CharSetting("V", 90.0f, 0.0f, -0.1f), new CharSetting("W", 90.0f, 0.0f, -0.1f),
            new CharSetting("X", 90.0f, 0.0f, -0.1f), new CharSetting("Y", 90.0f, 0.0f, -0.1f),
            new CharSetting("Z", 90.0f, 0.0f, -0.1f), new CharSetting("ａ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｂ", 90.0f, 0.0f, -0.1f), new CharSetting("ｃ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｄ", 90.0f, 0.0f, -0.1f), new CharSetting("ｅ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｆ", 90.0f, 0.0f, -0.1f), new CharSetting("ｇ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｈ", 90.0f, 0.0f, -0.1f), new CharSetting("ｉ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｊ", 90.0f, 0.0f, -0.1f), new CharSetting("ｋ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｌ", 90.0f, 0.0f, -0.1f), new CharSetting("ｍ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｎ", 90.0f, 0.0f, -0.1f), new CharSetting("ｏ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｐ", 90.0f, 0.0f, -0.1f), new CharSetting("ｑ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｒ", 90.0f, 0.0f, -0.1f), new CharSetting("ｓ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｔ", 90.0f, 0.0f, -0.1f), new CharSetting("ｕ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｖ", 90.0f, 0.0f, -0.1f), new CharSetting("ｗ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｘ", 90.0f, 0.0f, -0.1f), new CharSetting("ｙ", 90.0f, 0.0f, -0.1f),
            new CharSetting("ｚ", 90.0f, 0.0f, -0.1f), new CharSetting("Ａ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｂ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｃ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｄ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｅ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｆ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｇ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｈ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｉ", 90.0f, 0.0f, -0.1f),
            ...
            new CharSetting("Ｖ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｗ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｘ", 90.0f, 0.0f, -0.1f), new CharSetting("Ｙ", 90.0f, 0.0f, -0.1f),
            new CharSetting("Ｚ", 90.0f, 0.0f, -0.1f), new CharSetting("：", 90.0f, 0.0f, -0.1f),
